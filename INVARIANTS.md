...
- **Human-Controlled Clinical Pain Screening:** Standardized pain observation instruments—specifically the Non-Communicating Children's Pain Checklist – Postoperative Version (NCCPC-PV; [Breau et al., 2002](https://doi.org/10.1097/00000542-200203000-00004), *Anesthesiology*; cut-off $\ge 11$ for moderate-to-severe pain across 27 items over a 10-minute observation window) versus the outpatient NCCPC-R ([Breau et al., 2002](https://doi.org/10.1016/S0304-3959(02)00179-3), *Pain*; cut-off $\ge 7$ for pain across 30 items over a 2-hour observation window)—require direct human caregiver observation. Because the 2-hour observation requirement of the NCCPC-R makes it unsuitable for immediate post-episode checks, the acute in-the-moment workflow offered on the caregiver's mobile device is structured around the 10-minute, 27-item observation. If the caregiver suspects somatic pain, they complete this checklist manually in the app. Automated models must never synthesize artificial checklist scores or claim automated clinical validation.
